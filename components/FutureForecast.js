...
const FutureForecastItem = ({forecastItem}) => {
    ...
    return (
        <View  style={styles.futureForecastItemContainer}>
            ...
            <Text  style={styles.temp}>Low {Math.round((forecastItem.main.temp_min - 273.15))}°C</Text>
            <Text  style={styles.temp}>High {Math.round((forecastItem.main.temp_max- 273.15))}°C</Text>
        </View>
    )
}
